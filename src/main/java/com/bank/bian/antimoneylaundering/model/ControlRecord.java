package com.bank.bian.antimoneylaundering.model;
...
/**
 * The BIAN control record for this service domain: "AML Alert Monitoring State".
 *
 ...
 * to its asset type (AML Alert). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "AML Alert Monitoring State";
